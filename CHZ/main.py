...
fp = open("CHZ/08082022/1hour/chz_trans_data_1hour_080822.csv", 'r')
...
num_nodes, num_edges, num_self, strong_comp, dens = tg.perform_calculations(
    digraph)
...
data = pd.read_csv('CHZ/08082022/1hour/chz_trans_data_1hour_080822.csv')
