...
fp = open("eth_trans_data_1hour_080522.csv", 'r')
...
data = pd.read_csv('eth_trans_data_1hour_080522.csv')
...
# Show the graph
net1.show("eth_trans_data_1hour_080522.html")
# net2.show("eth_trans_data_1hour_minus_dex_080522.html")
